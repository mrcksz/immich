...
class ShuffleStubTimelineService extends TimelineService {
  ShuffleStubTimelineService(super.query, this._randomAsset);
...
class CountingTimelineService extends TimelineService {
  CountingTimelineService(super.query);
...
LocalAsset videoAsset(String id) => LocalAsset(
  id: id,
  name: '$id.mp4',
  type: AssetType.video,
  createdAt: DateTime(2025, 3),
...
const kCompleted = VideoPlayerState(
  position: kVideoDuration,
  duration: kVideoDuration,
